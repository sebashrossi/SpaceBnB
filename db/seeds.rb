...
', address: 'Westgate House, 2a, Prebend St, London, N1 8PT', user_id: user2.id, price: rand(1...1000), guest_limit: rand(1...5000))
...
planet17 = Planet.create!(name: 'Hoth', description: 'It’s an inhospitable ice planet whose apex predator is the abominable snowman’s less-fuckable cousin, but it’s also home to tauntauns, the best Star Wars animal. I’d risk a lot to ride a tauntaun just once.', address: '15 Deshengmen W St, Bei Tai Ping Zhuang, Haidian Qu, Beijing Shi, China, 100872', user_id: user6.id, price: rand(1...1000), guest_limit: rand(1...5000))
